...
App.view.plantable.ClassTypeEditPanel = Ext.extend(Ext.grid.GridPanel, {
	title : '章节占分数比例',
	initComponent : function() {
		var me = this;
		var store = new Ext.data.Store({
			proxy : new Ext.data.HttpProxy({
				url : "App/servlet/PlanTableServlet.jss?method=getClassType&id="
						+ me.thisId,
				method : "get"
			}),
		...
		App.view.plantable.ClassTypeEditPanel.superclass.initComponent.apply(
				this, arguments);
	},
	create : function() {
		var me = this;
		var win = new App.view.plantable.ClassTypeEditWindow({
